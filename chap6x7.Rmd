...
`r if(NROW(t6x7j)>0){paste0("The expected model calibration sites and data sources are summarized in ",tbls(name = paste0("t6x7j", waterbody_name),display="cite"),". ", mod.loc[1], if(NROW(t57)>0){paste0(" Effective shade model calibrations sites are summarized in ", tbls(name = "t57", display="cite"), ".")}," The model inputs and parameters that are expected to be modified to improve model fit are described in Section 6.1.")}`

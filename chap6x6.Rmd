...
#hs <- knitr::knit_child(input = paste0("hs", hsv.num, ".Rmd"), quiet = TRUE)
#cat(hs, sep = '\n')

#print(knitr::kable(hsv.tbl, format = "pandoc", padding = 2,
#                   caption = tbls(name = paste0("hsv.tbl", model_extent),

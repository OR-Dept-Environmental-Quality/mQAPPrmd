...
hs78.tbl <- knitr::kable(hs78, format = "pandoc", padding = 2,
                             caption = tbls(name = "hs78", 
                                            caption = paste0("Summary of the model inputs that are different between Heat Source version 7 and Heat Source version 8.")))

```

### Heat Source version 8

The model parameters for Heat Source version 8 are similar to Heat Source version 7 with a few notable exceptions:        
...
`r tbls(name = "hs78", display="cite")` summarizes the list of model parameters that are different between Heat Source version 7 and Heat Source version 8.

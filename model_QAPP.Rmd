...
This Quality Assurance Project Plan (QAPP) summarizes the modeling approach to be used for the temperature TMDL replacement project applicable within `r knitr::combine_words(unique(sort(huc8.txt$huc8txt)))`, which are collectively called the Middle Willamette Subbasins. This QAPP project area excludes the maintems of the Willamette River, the North Santiam River and the South Santiam River, which are included in the Willamette River and Major Tributaries QAPP. 

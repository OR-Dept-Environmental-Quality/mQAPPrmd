...
if(qapp_project_area == "Willamette River Mainstem and Major Tributaries") {qapp_project_area_wms <- "Willamette River Mainstem and Major Tributaries QAPP project area"}
...
if(NROW(t52)>0){
  ...
  t52_tbl <-  knitr::kable(t52, format = "pandoc", padding = 2,
                           caption = tbls(name = "t52",
                                          caption = paste0("Streams and the TIR collection dates in the ", qapp_project_area_wms,".")))
  ...
  if(NROW(tgh.usgs)>0){
    ...
    tgh_usgs_tbl <- knitr::kable(tgh.usgs, format = "pandoc", padding = 2, row.names = NA,
                                 caption = tbls(name = "tgh.usgs",
                                                caption = paste0("Gage height data available from the USGS monitoring stations in the ", qapp_project_area_wms, ".")))
...
if(NROW(section.npdes.ind)>0){
  ...
  t55_ind_tbl <- knitr::kable(section.npdes.ind, format = "pandoc", padding = 2,
                              caption = tbls(name = "t55_ind",
                                             caption = paste0("Summary of individual NPDES permitted discharges in the ", qapp_project_area_wms, ".")))
  ...
  t55_gen1_tbl <- knitr::kable(section.npdes.gen.1, format = "pandoc", padding = 2,
                               caption = tbls(name = "t55_gen1",
                                              caption = paste0("Summary of current registrants under the general NPDES ",
                                                               ...
                                                               " permits in the ", qapp_project_area_wms, ".")))
...
if(NROW(t57)>0){
  ...
  t57_tbl <- knitr::kable(t57, format = "pandoc", padding = 2,
                          caption = tbls(name = "t57",
                                         caption = paste0("Effective shade data collected in the  ", qapp_project_area_wms, ".")))
...
if(NROW(t51.raws)>0){
  ...
  t51_raws_tbl <- knitr::kable(t51.raws, format = "pandoc", padding = 2,
                               caption = tbls(name = "t51_raws",
                                              caption = paste0("Meteorological stations and data, including ", knitr::combine_words(unique(sort(tolower(raws.station.tbl$Parameter)))), ", available in the Remote Automatic Weather Station (RAWS) database in the ", qapp_project_area_wms, ".")))
...
if(NROW(t51.agrimet)>0){
  ...
  t51_agrimet_tbl <- knitr::kable(t51.agrimet, format = "pandoc", padding = 2,
                                  caption = tbls(name = "t51_agrimet",
                                                 caption = paste0("Meteorological stations and data, including air temperature, precipitation, relative humidity and wind, available in the USBR AgriMet database in the ", qapp_project_area_wms, ".")))
...
if(NROW(t51.hydromet)>0){
  ...
  t51_hydromet_tbl <- knitr::kable(t51.hydromet, format = "pandoc", padding = 2,
                                   caption = tbls(name = "t51_hydromet",
                                                  caption = paste0("Meteorological stations and data available in the USBR Hydromet database in the ", qapp_project_area_wms, ".")))
...
if(NROW(t51.mw)>0){
  ...
  t51_mw_tbl <- knitr::kable(t51.mw, format = "pandoc", padding = 2,
                             caption = tbls(name = "t51_mw",
                                            caption = paste0("Meteorological stations and data, including air temperature, precipitation, relative humidity, wind speed and wind direction, available in the MesoWest database in the ", qapp_project_area_wms, ".")))
...
if(NROW(t51.sp)>0){
  ...
  t51_sp_tbl <- knitr::kable(t51.sp, format = "pandoc", padding = 2,
                             caption = tbls(name = "t51_sp",
                                            caption = paste0("Meteorological data provided to DEQ from the various sources for the ", qapp_project_area_wms, ".")))
...
if(NROW(t53_1)>0){
  ...
  t53_1_tbl <-  knitr::kable(t53_1, format = "pandoc", padding = 2,
                             caption = tbls(name = "t53_1",
                                            caption = paste0("Continuous temperature monitoring stations in the ", qapp_project_area_wms, " currently available in public databases and DEQ files.")))
...
if(NROW(temp.data.sample.count)>0){
  ...
  app_b_tbl <- knitr::kable(app.b, format = "pandoc", padding = 2,
                            caption = tbls(name = "app.b",
                                           caption = paste0("Summary of existing temperature data in the ", qapp_project_area_wms,". Columns Jan – Dec indicate the number of daily maximum temperature results in each month. Data from the DEQ files that are not in the databases were not summarized in the table.")))
...
if(NROW(t54_usgs)>0){
  ...
  t54_usgs_tbl <- knitr::kable(t54_usgs, format = "pandoc", padding = 2, row.names = NA,
                               caption = tbls(name = "t54_usgs",
                                              caption = paste0("Continuous flow measurements available from the USGS flow gaging stations in the ", qapp_project_area_wms, ".")))
...
if(NROW(t54_owrd)>0){
  ...
  t54_owrd_tbl <- knitr::kable(t54_owrd, format = "pandoc", padding = 2, row.names = NA,
                               caption = tbls(name = "t54_owrd",
                                              caption = paste0("Continuous flow measurements available from the OWRD flow gaging stations in the ", qapp_project_area_wms, ".")))
...
if(NROW(t54_hydromet)>0){
  ...
  t54_hydromet_tbl <- knitr::kable(t54_hydromet, format = "pandoc", padding = 2, row.names = NA,
                                   caption = tbls(name = "t54_hydromet",
                                                  caption = paste0("Continuous flow measurements available from the USBR Hydromet monitoring stations in the ", qapp_project_area_wms, ".")))
...
if(NROW(t54_sp)>0){
  ...
  t54_sp_tbl <- knitr::kable(t54_sp, format = "pandoc", padding = 2, row.names = NA,
                             caption = tbls(name = "t54_sp",
                                            caption = paste0("Flow measurements from DEQ and other public databases in the ", qapp_project_area_wms, ".")))
...
if(NROW(t54_ins_flow)>0){
  ...
  t54_ins_flow_tbl <- knitr::kable(t54_ins_flow, format = "pandoc", padding = 2, row.names = NA,
                                   caption = tbls(name = "t54_ins_flow",
                                                  caption = paste0("Instantaneous flow measurements made by DEQ in the ", qapp_project_area_wms, ".")))
...
if(NROW(flow.data.sample.count)>0){
  ...
  app_c_tbl <- knitr::kable(flow.data.sample.count, format = "pandoc", padding = 2,
                            caption = tbls(name = "flow.data.sample.count",
                                           caption = paste0("Summary of existing flow data in the ", qapp_project_area_wms,". Columns Jan – Dec indicate the number of daily mean flow results in each month.")))
...
The Clean Water Act requires TMDLs be developed for waterbodies that do not meet water quality standards and are listed as water quality impaired on the State’s 303(d) list. The `r paste0(qapp_project_area_wms, if(str_sub(qapp_project_area,-1,-1) == "s"){paste0(" include")}else{paste0(" includes")})` several waterbodies listed on the Oregon 2018/2020 Section 303(d) Category 5 list as water quality limited for temperature (`r tbls(name = "tcat5", display="cite")`). `r if(length(unique(model.info$'TMDL Document'))==1){paste0("A TMDL was previously developed for the ", qapp_project_area_wms, " (", knitr::combine_words(strip_alpha(unique(sort(ref.intr[which(ref.intr$'Project Area' == qapp_project_area),]$"Abbreviated Reference"))),sep = "; "), ") but it must be replaced due to recent litigation.")}else{paste0("TMDLs were previously developed for the ",qapp_project_area_wms, " (", knitr::combine_words(strip_alpha(unique(sort(ref.intr[which(ref.intr$'Project Area' == qapp_project_area),]$"Abbreviated Reference"))),sep = "; "), ") but they must be replaced due to recent litigation.")}`
...
Stream temperatures for the `r pro.area.tmdls` will be simulated using `r if(NROW(tmdl.mod.b)>0){knitr::combine_words(tmdl.mod.b$'Model Version')}`. The models extents include most of the main rivers and their larger tributaries that contain or influence primary fish habitat. Site-specific load allocations will be developed for the streams that are simulated. Other streams are assigned generalized load allocations based on effective shade surrogate measures that target site potential or restored vegetation types. Numeric or narrative wasteload allocations will be developed for all NPDES permittees.
...
Meteorological data includes air temperature, sky conditions, cloudiness, relative humidity, and wind speed. `r paste0(tbls(name = tables.met$tbl_name[1], display="cite"), " through ", tbls(name = tables.met$tbl_name[length(tables.met$tbl_name)], display="cite"))` in Appendix A list the stations where meteorological data available in the `r qapp_project_area_wms`, including `r t51_txt`. The meteorological monitoring stations are also shown in the HTML interactive map that accompanies this QAPP and is referenced in Appendix E. The station IDs in `r tbls(name = tables.met$tbl_name[1], display="cite")` are the NCDC ID, which may differ from the station identifiers used by other sources.
...
DEQ contracted with Watershed Sciences, Inc. to provide airborne Thermal Infrared Radiometry (TIR) imagery of spatial temperature patterns within the `r qapp_project_area_wms` (`r sort(unique(t52_ref$'Abbreviated Reference'))`). TIR data is used to characterize the thermal regime of the streams and habitat quality. All streams and the TIR collection dates are summarized in `r tbls(name = "t52", display="cite")`.
...
Appendix B summarizes `r nrow(t53_1)` locations where continuous stream temperature data were collected in the `r qapp_project_area_wms` and the organizations that collected that data in `r tbls(name = "t53_1", display="cite")`, and when data were collected at each location in `r tbls(name = "app.b", display="cite")`. The location of these stations is shown in the HTML interactive map that accompanies this QAPP and referenced in Appendix E.

## Stream flow data

`r if(NROW(tables.flow) == 1){paste0(tbls(name = tables.flow$tbl_name, display="cite"), " in Appendix C lists")} else {paste0(tbls(name = tables.flow$tbl_name[1], display="cite"), " through ", tbls(name = tables.flow$tbl_name[nrow(tables.flow)], display="cite"), " in Appendix C list")}`  the stations where continuous flow volume data were available in the `r qapp_project_area_wms`, including `r t54_txt`. The location of these stations is shown in the HTML interactive map that accompanies this QAPP and referenced in Appendix E. `r if(NROW(t54_ins_flow)>0){paste0(tbls(name = "t54_ins_flow", display="cite"), " lists the locations where instantaneous flow volume measurements made by DEQ were available.")}` DEQ relies upon the quality control checks implemented by USGS and OWRD. DEQ-collected stream flow measurements utilize field and quality control methods outlined in DEQ’s Mode of Operations Manual (DEQ, 2009).
...
The project schedule for the `r qapp_project_area_wms` TMDL is scheduled to occur in two phases. The pre TMDL project phase, and the TMDL and WQMP development phase.

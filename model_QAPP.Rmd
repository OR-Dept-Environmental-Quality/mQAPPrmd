...
ref.pro.area <- ref %>% 
  ...
  dplyr::mutate(Reference_Year =     
                  ...
                  #                                   # Watershed Sciences ---
                                                     ifelse(Reference == '"Aerial Surveys in the Fifteenmile Creek Basin. Prepared for Oregon Department of Environmental Quality. February 26, 2003."',"2003a",
                                                            ifelse(Reference == '"Aerial Surveys in the Willamette River Basin, Thermal Infrared and Color Videography. Prepared for Oregon Department of Environmental Quality. April 25, 2003."',"2003b",
...
t51.sp <- t51 %>% 
  ...
  dplyr::filter(!Source == "DEQ") # M.Columbia-Hood

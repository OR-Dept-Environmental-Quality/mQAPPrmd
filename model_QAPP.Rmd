...
other.ref <- data.frame(reference = c(
  ...
  'DEQ (Oregon Department of Environmental Quality). 2021. Oregon Water Quality Monitoring Data Portal. Accessed at https://www.oregon.gov/deq/wq/Documents/AWQMSguiddatausers.pdf.',

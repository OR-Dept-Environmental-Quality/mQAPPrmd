...
Where and when the applicable criteria apply are based on the designated fish uses maps in OAR `r project.areas[which(project.areas$areas == qapp_project_area)]$"OAR 340-041"` `r project.areas[which(project.areas$areas == qapp_project_area)]$"OAR 340-041 Figure"`.

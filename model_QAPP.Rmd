...
This Quality Assurance Project Plan (QAPP) summarizes the modeling approach to be used for the temperature TMDL replacement project applicable within `r knitr::combine_words(unique(sort(huc8.txt$huc8txt)))`. The modeling approach to be used in the North Umpqua Subbasin (17100301) is described in the modeling QAPP DEQ22-HQ-0006-QAPP (DEQ, 2022).

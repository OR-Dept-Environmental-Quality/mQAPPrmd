...
This QAPP is consistent with DEQ’s and USEPA’s modeling QAPP guidance (DEQ, 2017; EPA, 2016) and documents the analysis and numerical modeling approach that will support the updated `r qapp_project_area` temperature TMDLs as well as other project details. In particular, this QAPP details the following:
...
Several SHADOW models (USFS, 1993) already exist and were used to model shade on multiple streams for TMDLs in the Rogue Basin (DEQ, 2002a; DEQ, 2004; DEQ, 2007). DEQ does not plan to update these models or use SHADOW for development of new shade or temperature models.

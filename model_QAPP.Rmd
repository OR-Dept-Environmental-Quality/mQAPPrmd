...
`r if(qapp_project_area == "Willamette River Mainstem and Major Tributaries"){paste0("The temperature models for the Coast Fork and Middle Fork Willamette River, the lower McKenzie River, the North Santiam and Santiam River, the South Santiam River, and upper and middle Willamette River will be developed using CE-QUAL-W2 4.2 by USGS ([Update: cite the USGS report.]).")}`

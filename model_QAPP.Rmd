...
* Updating the Umpqua River model to include current discharges from Brandy Bar Landing, Reedsport STP, and Winchester Bay STP.       
* Updating the South Umpqua River model to include current discharges from Canyonville STP, Winston Green Waste Water Treatment Facility, Hoover Treated Wood Products, Myrtle Creek STP, Roseburg STP, and the Umpqua National Forest Tiller Ranger Station STP.       
* Updating the Calapooya Creek model to include current discharges from Oakland STP, and Sutherlin STP.       
* Updating the Cow Creek model to include current discharges from Glendale STP, and Riddle STP.       

...
`r tbls(name = "t54_usgs", display="cite")` - `r tbls(name = "t54_sp", display="cite")` lists the stations for flow volume data and other instream measurements that were available in USGS, Oregon DEQ, and other public databases.

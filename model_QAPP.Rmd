...
other.ref <- data.frame(reference = c(
  ...
  'DEQ (Oregon Department of Environmental Quality). 2013. "Data validation criteria for water quality parameters measured in the field. DEQ04-LAB-0003-QAG Version5.0."',
...
18.	2018/2020 303(d) Integrated Report status that are classified as water quality limited Category 5 or Category 4A for temperature.       

...
Historically, human activities have altered the stream morphology and hydrology and decreased the amount of riparian vegetation in the basin. The subbasin includes urban, agricultural, and forested lands. Additionally, multiple points of diversion in the Sandy River Subbasin have altered stream flow levels.
...
* Updating the Sandy River model boundary conditions and tributary inputs to reflect conditions in 2016.

* Updating the Sandy River model to include current discharges from the City of Troutdale Water Pollution Control Facility and the WES Hoodland Sewage Treatment Plant.       

* Updating the Bull Run River model boundary conditions and tributary inputs to reflect conditions in 2016.

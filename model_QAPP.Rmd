...
if(NROW(t51_2)>0){
  print(knitr::kable(t51_2, format = "pandoc", padding = 2,
                     caption = tbls(name = "t51_2",
                                    caption = paste0("Meteorologcial stations and data available in the National Climatic Data Center (NCDC) database in the ",
                                                     qapp_project_area, "."))) %>%
          kableExtra::kable_styling() %>% 
          kableExtra::add_footnote(label = paste0("Data were retrieved from NOAA National Climatic Data Center (https://www.ncdc.noaa.gov/) on ", update.date, "." ))
        )
}

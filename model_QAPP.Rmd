...
t57 <- effective.shade.pro.area %>% 
  ...
  dplyr::select(`Station ID` = `Site ID`,
                ...
                `Effective Shade`,
                `Data Source`) %>% 
  dplyr::filter(is.na(`Effective Shade`)) # Mid-Willamette: effective shade has no data

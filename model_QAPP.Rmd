...
The BBNC for waterbodies in the John Day River Basin include:       
...
Since the issuance of the original TMDL, the number of waterbodies that are identified as water quality limited for temperature on the Oregon 2018/2020 Section 303(d) Category 5 list has changed since the original TMDL was developed. As part of the TMDL update, DEQ will address all current temperature listings based on the most recent integrated report list. The current listings, as they pertain to the `r qapp_project_area` QAPP project area, are summarized in `r tbls(name = "tcat5", display="cite")`.
...
Historically, human activities have altered the stream morphology and hydrology and decreased the amount of riparian vegetation in the basin. The basin includes agricultural, grazing, and forested lands, with some urban areas comprising a small portion of the land base.  Some surface water consumption occurs within the basin, through irrigation primarily.  Irrigation can contribute to elevated stream temperatures as water use can decrease low summertime flows, in turn reducing the thermal assimilative capacity of streams.

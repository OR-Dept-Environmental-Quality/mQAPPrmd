...
This Quality Assurance Project Plan (QAPP) summarizes the modeling approach to be used for the replacement temperature TMDLs applicable within `r knitr::combine_words(unique(sort(huc8.txt$huc8txt)))`. **[Update: This QAPP project area excludes the (list rivers if applicable).]**

...
t57 <- effective.shade.pro.area %>% 
  ...
  dplyr::select(#`Station ID` = `Site ID`, # branch edit
                Station = `Site Name`,
                `Latitude/Longitude`,
                `Effective Shade`,
                `Data Source`)
...
* Updating the Willow Creek model to characterize current discharges from the Heppner STP.

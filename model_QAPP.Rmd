...
cal.model <- readxl::read_xlsx(paste0(data.dir, "Model_Setup_Info.xlsx"),
                               sheet = "Calibration Model Setup Info")

cal.tir <- readxl::read_xlsx(paste0(data.dir, "Model_Setup_Info.xlsx"),
                               sheet = "TIR Calibration")
...
usgs.station.tbl <- usgs.station.subbasins %>% 
  ...
  dplyr::mutate_at("Station Name", str_replace_all, ",OR", "") %>% 
  dplyr::mutate_at("Station Name", str_replace_all, ", OR", "") %>% 
  dplyr::mutate_at("Station Name", str_replace_all, " OR", "") %>% 

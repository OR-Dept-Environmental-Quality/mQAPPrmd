...
`r if(!is.na(unique(section.model.info$"Veg Notes"))){paste0("The shading from near stream vegetation inputs to the model include vegetation height and canopy cover. ", unique(section.model.info$"Veg Notes"))}`

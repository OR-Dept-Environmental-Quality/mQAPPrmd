...
if(waterbody_name %in% c("Antelope Creek","Bear Creek","Little Applegate River",
                         "Little Butte Creek and North Fork Little Butte Creek")){
  
  sc_txt <- paste0("reductions to stream flow rate or volume, and background sources (",section.model.info$Cite_inText,"). Other potential sources include channel modification and widening and warming caused by climate change. ")
  
  
} else {
  
  sc_txt <- paste0("and background sources (",section.model.info$Cite_inText,"). Other potential sources include channel modification and widening, reductions to stream flow rate, and warming caused by climate change. ")
  
}

```

`r if(!waterbody_name %in% c("Applegate River","Rogue River")){paste0("The primary sources of thermal loading contributing to temperatures exceedances in ",paste0(the,waterbody_name)," include increases in solar radiation loading from the disturbance or removal of near-stream vegetation",ifelse(waterbody_name %in% c("Antelope Creek","Bear Creek","Little Applegate River","Little Butte Creek and North Fork Little Butte Creek"),paste0(", "),paste0(" ")),if(npdes.ind.n>0){paste0("point source discharges, ")},sc_txt,"The contribution of these latter potential sources may be investigated as part of the model scenarios.")}`

`r if(waterbody_name %in% c("Applegate River")){paste0("The primary sources of thermal loading contributing to temperatures exceedances in the Applegate River include increases in solar radiation loading from the disturbance or removal of near-stream vegetation, and background sources (DEQ, 2004). Other potential sources include point source discharges, reductions to stream flow rate or volume, channel modification and widening, releases and management of water impounded by Applegate Dam, and warming caused by climate change. The contribution of these latter potential sources may be investigated as part of the model scenarios.")}`

`r if(waterbody_name %in% c("Rogue River")){paste0("The primary sources of thermal loading contributing to temperatures exceedances in the Rogue River include increases in solar radiation loading from the disturbance or removal of near-stream vegetation, point source discharges, reductions to stream flow rate or volume, releases and management of water impounded by William L. Jess Dam, and background sources (DEQ, 2008). Other potential sources include channel modification and widening and warming caused by climate change. The contribution of these latter potential sources may be investigated as part of the model scenarios.")}`
...
`r if(waterbody_name %in% c("Applegate River","Little Applegate River")){paste0("Model development for ",paste0(the,waterbody_name)," will be completed by DEQ and assumptions will be documented in the TMDL. Other key assumptions about model constants are described in the Heat Source model user guide (Boyd and Kasper, 2003).")}else{paste0("The effort currently described in the QAPP includes use of existing models. Key calibration assumptions made during the model setup and calibration process were documented in the original ",section.model.info$'TMDL Document',"(",section.model.info$Cite_inText,") and the model user guide (Boyd and Kasper, 2003).")}`

...
`r if(waterbody_name == "Johnson Creek"){paste0("Near stream vegetation inputs to the model include vegetation height and canopy cover. These inputs were derived by digitizing and classifying riparian vegetation type polygons based on aerial photos.")}`

`r if(waterbody_name == "Johnson Creek"){paste0("Near stream vegetation inputs to the model include vegetation height and canopy cover. These inputs were derived from Lidar data.")}`

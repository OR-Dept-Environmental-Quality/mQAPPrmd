...
## 1st paragraph
source.char.1 <- readxl::read_xlsx("//deqhq1/TMDL/Planning statewide/Temperature_TMDL_Revisions/model_QAPPs/R/data/tables.xlsx",
                                 sheet = "midW_sourceChar") %>%
  dplyr::filter(`Model Waterbody` == waterbody_name) %>% 
  dplyr::pull(sourceChar1)

source.char.2 <- readxl::read_xlsx("//deqhq1/TMDL/Planning statewide/Temperature_TMDL_Revisions/model_QAPPs/R/data/tables.xlsx",
                                 sheet = "midW_sourceChar") %>%
  dplyr::filter(`Model Waterbody` == waterbody_name) %>% 

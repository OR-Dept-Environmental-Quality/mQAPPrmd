...
if(NROW(t6x6_2)>1){
  ...
  cat("Near stream vegetation inputs to the model include vegetation height and canopy cover. These inputs were derived by digitizing and classifying riparian vegetation type polygons based on aerial photos.")
  
  cat("\\n")
  
  cat("Near stream vegetation inputs to the model include vegetation height and canopy cover. These inputs were derived from Lidar data.")

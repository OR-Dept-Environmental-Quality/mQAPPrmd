...
if(waterbody_name %in% c("John Day River")){
  ...
  sc_txt <- "reductions to the stream flow rate or volume, and background sources (DEQ, 2010). Other potential sources include channel modification and widening, and warming caused by climate change. "
  
} else {
  
  sc_txt <- "and background sources (DEQ, 2010). Other potential sources include channel modification and widening, reductions to stream flow rate, and warming caused by climate change. "                      

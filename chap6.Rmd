...
if(NROW(dma.waterbody)>0){
  ...
  dma.wb.tbl <- knitr::kable(dma.waterbody, format = "pandoc", padding = 2,
                             caption = tbls(name = paste0("dma.waterbody",waterbody_name),
                                            caption = ifelse(waterbody_name == "McKenzie River: Upper", 
                                                             paste0("Summary of potential designated management agencies (DMAs) or responsible persons within 100 meters of the digitized centerline of the upper portion of the McKenzie River."),
                                                             paste0("Summary of potential designated management agencies (DMAs) or responsible persons within 100 meters of the digitized ", waterbody_name, " centerline."))))

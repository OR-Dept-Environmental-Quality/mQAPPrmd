...
To the greatest extent possible, the method used to derive the model parameters for the existing TMDL models have been summarized in the boundary conditions and tributary inputs table (`r if(!model.extent == TRUE){tbls(name = paste0("t6x6j", waterbody_name),display="cite")} else {tbls(name = paste0("t6x6_1", waterbody_name),display="cite")}`).

...
# for test: waterbody_name <- "Salmon River"
...
if(!model.extent == TRUE){
  ...
  t6x6_met <- section.model.input %>% 
    ...
    dplyr::summarize(`Model Location` = toString(unique(sort(round(`Model Location`,2)))),
                     #`Model Location` = toString(unique(sort(round(as.numeric(`Model Location`),2)))),
  ...
  t6x6_1 <- section.model.input %>% 
    ...
    dplyr::mutate(`Model Location Name (Station ID)` = ifelse(`Station ID` == "No Station ID" | is.na(`Station ID`),
                                                              ...
                                                              paste0(`Model Location Name`, " (", `Station ID`, ")")),
                  `Model Location` = round(`Model Location`,2),
                  #`Model Location` = as.character(`Model Location`),

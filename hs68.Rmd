...
Heat Source version 8 is similar to Heat Source version 6 with a few notable exceptions discussed in this section. The general differences between the two sets of model parameters are outlined below, with a complete list of different model parameters summarized in `r tbls(name = "hs68", display="cite")`. Heat Source version 8:

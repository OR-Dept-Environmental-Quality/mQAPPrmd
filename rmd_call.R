...
output.dir <- "//deqhq1/TMDL/Planning statewide/Temperature_TMDL_Revisions/model_QAPPs/R/test_doc/20240406"

project.areas <- readxl::read_excel(paste0(data.dir,"qapp_project_areas.xlsx"))

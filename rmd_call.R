...
output.dir <- "//deqhq1/TMDL/Planning statewide/Temperature_TMDL_Revisions/model_QAPPs/R/test_doc/202108"
...
#for (qapp_project_area in project.areas$areas) {
  ...
  rmarkdown::render(input="E:/PROJECTS/20200810_RyanMichie_TempTMDLReplacement/R/branches/Southern_Willamette_Subbasins/mQAPPrmd/model_QAPP.Rmd",

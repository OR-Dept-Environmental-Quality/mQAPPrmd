...
t5134 <- section.model.input %>% 
  ...
  dplyr::select(StationDes, `Model Location`, `Station ID`, `Data Source`) %>% 
  dplyr::rename(`Station Description` = StationDes,
                `Modle Kilometer` = `Model Location`)
...
t5135 <- section.model.input %>% 
  ...
  dplyr::select(StationDes, `Model Location`, `Input Parameter`, `Station ID`, `Data Source`) %>% 
  dplyr::rename(`Station Description` = StationDes,
                `Modle Kilometer` = `Model Location`,
